...
print(f'The players are {war.player_a.player_name} and {war.player_b.get_card} with {cards} cards each.\n'
...
for i in range(10):
    ...
    if card1 > card2:
        ...
        print(f'The winner is {war.player_a.player_name}!')
    else:
        war.player_b.add_card(card1)
        war.player_b.add_card(card2)
        print(f'The winner is {war.player_b.player_name}!')
